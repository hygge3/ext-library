...
public class Codegen {
    private static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/next_meal?zeroDateTimeBehavior=CONVERT_TO_NULL&rewriteBatchedStatements=true";
    private static final String DB_USERNAME = "root";
    private static final String DB_PASSWORD = null;

    private static final String BASE_PACKAGE = "ext.library.eatpick";
    private static final String SOURCE_DIR = "demo/eatpick/src/main/java";
    private static final String[] TABLE_PREFIX = new String[]{};
    private static final String[] GENERATE_TABLES = new String[]{};
